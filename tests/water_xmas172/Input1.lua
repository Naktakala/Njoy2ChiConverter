...
xs_h_water = chiPhysicsTransportXSCreate()
xs_o16 = chiPhysicsTransportXSCreate()
chiPhysicsTransportXSSet(xs_h_water,CHI_XSFILE,"../../output/ENDF-B-VII-1/xmas172/H_water.csx")
chiPhysicsTransportXSSet(xs_o16,CHI_XSFILE,"../../output/ENDF-B-VII-1/xmas172/O16.csx")

water = chiPhysicsTransportXSMakeCombined({{xs_h_water,6.6691E-2},
                                           {xs_o16,3.3346E-2}})
...
gs1 = chiLBSCreateGroupset(phys1)
cur_gs = gs1
chiLBSGroupsetAddGroups(phys1,cur_gs,50,num_groups-1)
