...
chiPhysicsTransportXSSet(xs_o16,CHI_XSFILE,"../../output/ENDF-B-VII-1/xmas172lanl48/O16.csx")
xs = chiPhysicsTransportXSGet(xs_o16)
num_groups = xs["G"]
...
cur_gs = gs0
chiLBSGroupsetAddGroups(phys1,cur_gs,0,69)
...
gs0 = chiLBSCreateGroupset(phys1)
cur_gs = gs0
chiLBSGroupsetAddGroups(phys1,cur_gs,70,171)
chiLBSGroupsetSetQuadrature(phys1,cur_gs,pquad1)
chiLBSGroupsetSetAngleAggDiv(phys1,cur_gs,1)
chiLBSGroupsetSetGroupSubsets(phys1,cur_gs,1)
chiLBSGroupsetSetAngleAggregationType(phys1,cur_gs,LBSGroupset.ANGLE_AGG_SINGLE)
...
gs0 = chiLBSCreateGroupset(phys1)
cur_gs = gs0
chiLBSGroupsetAddGroups(phys1,cur_gs,172,num_groups-1)
chiLBSGroupsetSetQuadrature(phys1,cur_gs,pquad1)
chiLBSGroupsetSetAngleAggDiv(phys1,cur_gs,1)
chiLBSGroupsetSetGroupSubsets(phys1,cur_gs,1)
chiLBSGroupsetSetAngleAggregationType(phys1,cur_gs,LBSGroupset.ANGLE_AGG_SINGLE)
